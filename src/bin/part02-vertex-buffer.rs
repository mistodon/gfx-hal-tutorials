...
fn main() {
    ...
    let instance = backend::Instance::create("Part 01: Vertex buffers", 1);
    ...
    let (vertex_buffer, vertex_buffer_memory) = {
        ...
        let unbound_buffer = device.create_buffer(buffer_len, buffer::Usage::VERTEX).unwrap();
    ...
    loop {
        ...
        let finished_command_buffer = {
            ...
            command_buffer.bind_vertex_buffers(0, VertexBufferSet(
                vec![(&vertex_buffer, 0)]));
